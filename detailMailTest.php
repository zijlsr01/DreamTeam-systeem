		...
		<div class="contentContent">
			...
			<?php
				...
				if(!empty($error)){ ?>
					...
					<form action="https://www.expect-webmedia.nl/drpr/mailing-detail-test/?mailID=<?php echo $mailID; ?> " method="post" name="instellingen">
					Onderwerp E-mail<br />
  ...
  <tr>
	...
	<div id="contentRechts">
		...
		<div id="buttonContainer">
			...
			<div class="buttonNew" onclick="location.href='/drpr/mailing-detail-test/?mailID=<?php echo $mailID; ?>&send=<?php echo $mailID; ?>';">
				Verstuur E-mail
			</div>
			<?php 
			$toDay = date('Ymd');
			...
			<div class="button2New" onclick="location.href='/drpr/mailing-detail-test/?mailID=<?php echo $mailID; ?>&reminder=<?php echo $mailID; ?>';">
				Verstuur Reminder
			</div>
