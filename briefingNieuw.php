...
get_header();
	...
	<div id="contentLinks">
        ...
        Categorien *<br />
				...
				?>
				<select name="categorie" onchange="mailSelectCheck(this);" required >
				...
				<?php foreach($categorien as $categorie){  ?>
					<option value="<?php echo $categorie->catKey; ?>" <?php if($_POST['categorie'] == "<?php echo $categorie->catKey; ?>"){ ?> selected="selected"<?php } ?>><?php echo $categorie->catName; ?></option>
				<?php } ?>
				</select><br /><br />
<!-- subcategorien -->
				<?php 
	...
	<div id="<?php echo $categorie->catKey; ?>" style="display: none;">
        Subcategorie <?php echo $categorie->catName; ?> *<br />
				<select name="<?php echo $subCatID; ?>" onchange="calculateTotal();">
					<option value="keuze" <?php if($subCatPOST == "keuze"){ ?>selected="selected"<?php } ?>>- Maak een keuze -</option>
					<?php 
						foreach($subCategorien as $subCategorie){ ?>
						<option value="<?php  echo $subCategorie->subcatName; ?>" <?php if($_POST["$subCatID"] == $subCategorie->subcatName){ ?>selected="selected"<?php } ?>><?php  echo $subCategorie->subcatName; ?></option>
     ...
     <!-- subsubcategorien -->
				<?php 
					$categorien = $wpdb->get_results("SELECT * FROM Subcategorien" );
					foreach($categorien as $categorie){ ?>
					<?php
						$subCategorien = $wpdb->get_results("SELECT * FROM SubSubcategorien WHERE hoofdSubCatID = $categorie->ID" );
						$subCatID = "subcat".ucfirst($categorie->catKey);
						if(!empty($subCategorien)){	?>
	<div id="<?php echo $subCatID; ?>" style="display:none">NHL33
        Subcategorie <?php echo $categorie->subcatName;  ?> *<br />
				<select name="<?php echo $subCatID; ?>" onchange="calculateTotal();">
					<option value="keuze" <?php if($subCatPOST == "keuze"){ ?>selected="selected"<?php } ?>>- Maak een keuze -</option>
					<?php 
						foreach($subCategorien as $subCategorie){ ?>
						<option value="<?php  echo $subCategorie->catKey; ?>" <?php if($_POST["$subCatID"] == $subCategorie->subcatName){ ?>selected="selected"<?php } ?>><?php  echo $subCategorie->subcatName; ?></option>
