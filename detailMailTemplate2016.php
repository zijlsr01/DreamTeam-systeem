		...
		<div class="contentContent">
			...
			<?php
				...
				if(!empty($error)){ ?>
					...
					<form action="https://www.expect-webmedia.nl/drpr/mailing-detail/?mailID=<?php echo $mailID; ?> " method="post" name="instellingen">
					Onderwerp E-mail<br />
  ...
  <tr>
          ...
          <tr>
        	...
        	<td valign="top"><input type="checkbox" class="check" name="opleiding[]" id="Verpleegkunde"  value="Verpleegkunde"<?php if(in_array( "Verpleegkunde", $opleidingen)){ ?>checked<?php } ?> />
        	  <label for="Verpleegkunde">Verpleegkunde</label></td>
                    ...
                    Kan helpen bij invoerklus<br />
                      ...
                      <select name="fotoklus">
						<option value="nvt" <?php if($mailDetails->FotoKlus == "nvt"){ ?>selected="selected"<?php } ?>>Onbelangrijk</option>
						<option value="Ja" <?php if($mailDetails->FotoKlus == "Ja"){ ?>selected="selected"<?php } ?>>Ja</option>
					</select>
                    
                      <br /><br />
                        Kan helpen bij videoklus<br />
                      <select name="videoklus">
						<option value="nvt" <?php if($mailDetails->VideoKlus == "nvt"){ ?>selected="selected"<?php } ?>>Onbelangrijk</option>
						<option value="Ja" <?php if($mailDetails->VideoKlus == "Ja"){ ?>selected="selected"<?php } ?>>Ja</option>
					</select>
                    
                     <br /><br />
                        Kan helpen bij nabelactie<br />
                      <select name="nabelactie">
						<option value="nvt" <?php if($mailDetails->NabelActie == "nvt"){ ?>selected="selected"<?php } ?>>Onbelangrijk</option>
						<option value="Ja" <?php if($mailDetails->NabelActie == "Ja"){ ?>selected="selected"<?php } ?>>Ja</option>
					</select>
              ...
              <br /><br />
					...
					<br /><br />
					<a href="/drpr/mailing-detail-test/?mailID=<?php echo $mailID; ?>">Annuleren</a><input type="submit" value="E-mail bijwerken" name="maillijst" id="submit">
				</form>
			...
			<table border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<?php  
						...
						?>
							<li><a href="/drpr/activiteit-detail/?id=<?php echo $activiteit; ?>" target="_self"><?php echo $ActName; ?></a></li>
						<?php } }else{ ?>
			...
			<table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                 ...
                 <tr>
					...
					<td valign="top">:</td>
					<td valign="top"><?php if($mailDetails->FotoKlus == 'nvt'){echo "Onbelangrijk";}else{ echo $mailDetails->FotoKlus;} ?></td>
				</tr>
                 <tr>
					<td valign="top" width="130">Kan helpen bij videoklus</td>
					<td valign="top">:</td>
					<td valign="top"><?php if($mailDetails->VideoKlus == 'nvt'){echo "Onbelangrijk";}else{ echo $mailDetails->VideoKlus;} ?></td>
				</tr>
                  <tr>
					<td valign="top" width="130">Kan helpen bij nabelactie</td>
					<td valign="top">:</td>
					<td valign="top"><?php if($mailDetails->NabelActie == 'nvt'){echo "Onbelangrijk";}else{ echo $mailDetails->NabelActie;} ?></td>
				</tr>
			</table>
		</div>
		<?php } ?>
	...
	<div id="contentRechts">
		...
		<div id="buttonContainer">
			...
			<div class="buttonNew" onclick="location.href='/drpr/mailing-detail/?mailID=<?php echo $mailID; ?>&send=<?php echo $mailID; ?>';">
				Verstuur E-mail
			</div>
			<?php 
			$toDay = date('Ymd');
			...
			<div class="button2New" onclick="location.href='/drpr/mailing-detail/?mailID=<?php echo $mailID; ?>&reminder=<?php echo $mailID; ?>';">
				Verstuur Reminder
			</div>
			
			<div class="button3New"  onclick="window.open('http://www.expect-webmedia.nl/drpr/preview-email/?mailid=<?php echo $mailID; ?>')">
				 Preview E-mail
			</div>
		</div>
		<br /><br />
