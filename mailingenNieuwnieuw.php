		...
		<table border="0" cellpadding="5" cellspacing="3">
				...
				?>
							<tr >
								...
								<td valign="top"><a href="http://www.expect-webmedia.nl/drpr/mailingen-nieuw/?delml=<?php echo $maillijst->ID; ?>"  onclick="return confirm('Weet je zeker dat je deze E-mail wilt verwijderen?')">X</a></td>
							</tr>
				<?php } 
