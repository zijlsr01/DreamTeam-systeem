...
get_header();  get_header();
				...
				if($_POST['maillijst']){
					...
					if($_POST['fotoklus'] == 'keuze'){
						$error .= "<li>Selecteer a.u.b. of hij/zij kan helpen bij fotografieklus</li>";
					}
					
					if($_POST['videoklus'] == 'keuze'){
					$error .= "<li>Selecteer a.u.b. of hij/zij kan helpen bij videoklus</li>";
					}
					...
					$fotoklus = $_POST['fotoklus'];	
					$videoklus = $_POST['videoklus'];
					$nabelactie = $_POST['nabelactie'];				
  ...
  <tr>
        	  ...
        	  <label for="Verpleegkunde">Verpleegkunde</label></td>
                    ...
                    Kan helpen bij invoerklus<br />
                     ...
                     <br /><br />
                      ...
                      <select name="fotoklus">
						<option value="nvt" <?php if(!empty($error) && $_POST['fotoklus'] == "nvt"){ ?>selected="selected"<?php } ?>>Onbelangrijk</option>
                    ...
                    <br /><br />
                      ...
                      <select name="videoklus">
						<option value="nvt" <?php if(!empty($error) && $_POST['videoklus'] == "nvt"){ ?>selected="selected"<?php } ?>>Onbelangrijk</option>
                    ...
                    <br /><br />
                      ...
                      <select name="nabelactie">
						<option value="nvt" <?php if(!empty($error) && $_POST['nabelactie'] == "nvt"){ ?>selected="selected"<?php } ?>>Onbelangrijk</option>
	...
	<div id="contentRechts">
		...
		<table border="0" cellpadding="5" cellspacing="3">
				...
				?>
							<tr >
								<td valign="top" width="500" title="Deze mailing heeft <?php aantalOntvangersNieuw($maillijst2->ID); ?> ontvangers"> <B>&nbsp;&nbsp;<a href="http://www.expect-webmedia.nl/drpr/mailing-detail/?mailID=<?php echo $maillijst2->ID; ?>"><?php echo $onderwerp; ?> (<?php aantalOntvangersNieuw($maillijst2->ID); ?>)</a></B></td>
								<td valign="top"><a href="http://www.expect-webmedia.nl/drpr/mailingen-nieuw/?delml=<?php echo $maillijst2->ID; ?>"  onclick="return confirm('Weet je zeker dat je deze E-mail wilt verwijderen?')">X</a></td>
							</tr>
				<?php } 
		...
		<table border="0" cellpadding="5" cellspacing="3">
				...
				?>
							<tr >
								<td valign="top" width="500" title="Deze mailing heeft <?php aantalOntvangersNieuw($maillijst->ID); ?> ontvangers"> <B>&nbsp;&nbsp;<a href="http://www.expect-webmedia.nl/drpr/mailing-detail/?mailID=<?php echo $maillijst->ID; ?>"><?php echo $onderwerp; ?> (<?php aantalOntvangersNieuw($maillijst->ID); ?>)</a></B></td>
								<td valign="top"><a href="https://www.expect-webmedia.nl/drpr/mailingen-nieuw/?delml=<?php echo $maillijst->ID; ?>"  onclick="return confirm('Weet je zeker dat je deze E-mail wilt verwijderen?')">X</a></td>
							</tr>
				<?php } 
